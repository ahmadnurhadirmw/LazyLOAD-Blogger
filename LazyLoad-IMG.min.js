...
for(var ifrEl=document.querySelectorAll("iframe[src*='youtube.com']"),i=0;i<ifrEl.length;i++)ifrEl[i].getAttribute("src")&&(ifrEl[i].setAttribute("data-src",ifrEl[i].getAttribute("src").replace(/.*?:\/\//g , "//")),ifrEl[i].removeAttribute("src"),ifrEl[i].className+=" lazyload");
